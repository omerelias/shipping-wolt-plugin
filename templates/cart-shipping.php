	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( $available_methods ) : ?>
			<ul style="<?php echo (1 < count( $available_methods )? '' : 'display: none;'); ?>" id="shipping_method" class="woocommerce-shipping-methods">
				...
				// show( $our_shipping_available, 'our_shipping_available' );
				// show( $method->id, 'method->id' );

					?>
					<li class="<?php if(checked( $method->id, $chosen_method, false )) { echo 'li-checked'; } ?> <?php echo $method->id ?>" tabindex="0">
						<?php
